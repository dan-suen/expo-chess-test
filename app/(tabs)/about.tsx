  ...
  return (
    <ImageBackground source={imageSource} style={aboutStyles.backgroundImage}>
      ...
      <View style={aboutStyles.container}>
        <Text style={aboutStyles.text}>This is a TypeScript-based chess game built using ReactNative and Expo. The game allows replicating important features such as *en passant*, castling, etc.</Text>
      </View>
    </ImageBackground>
  );
}
